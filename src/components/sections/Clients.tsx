...
const Clients = () => {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-[#343434] via-[#5A5D5D] to-[#D7DADE]">
      <div className="px-6 mx-auto max-w-7xl sm:px-8 lg:px-12">
        {/* Encabezado */}
        <div className="text-center mb-10">
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-4 text-[#FFFFFF]">
